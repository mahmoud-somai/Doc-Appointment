...
const ListAppointment = () => {
  ...
  const loadAppointment=async()=>{
    const result=await axios.get(`http://localhost:8800/api/Appointment`);
    setData(result.data);
  }
  ...
  return (
    <div class="ap_parent">
    <div class="ap_div1"> 
    <div class="ap_div2"> <h1><span class="animated-text">List Of Appointment</span></h1> </div>
    <div class="ap_div3"> 
